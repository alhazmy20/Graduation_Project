...
return [
    ...
    */
    ...
    'uppercase' => 'الحقل :attribute يجب ان يكون بالأحرف الكبيرة ',
    ...
    */
    ...
    'attributes' => [
        ...
        'tName' => 'الاسم الثالث',
        'lName' => 'الاسم الاخير',
        'post_id' => 'رقم الفرصة التدريبية',
        'status_id' => 'رقم الحالة',
        'institutionName' => 'اسم المنشأة',
        'institutionSector' => 'قطاع المنشأة',
        'institutionField' => 'مجال المنشأة',
        'institutionPhone' => 'رقم هاتف المنشأة',
        'managerEmail' => 'البريد الالكتروني للمشرف',
        'managerPhone' => 'رقم هاتف المشرف',
        'managerPosition' => 'المسمى الوظيفي للمشرف',
        'region' => 'المنطقة',
        ...
        'content' => 'المحتوى',
        'logo' => 'الشعار',
        't_type' => 'نوع البرنامج التدريبي',
        'reward' => 'مكافأة',
        'GPA' => 'المعدل',
        'transcript' => 'السجل الأكاديمي',
        'nationalID' => 'الهوية الوطنية',
        'internshipLetter' => 'خطاب التدريب',
        'CV' => 'السيرة الذاتية',
        'personalPicture' => 'الصورة الشخصية',
        't_startDate' => 'تاريخ البدء',
        't_endDate' => 'تاريخ الانتهاء',
        'p_endDate' => 'تاريخ انتهاء الإعلان',
        'majors' => 'التخصصات',
        'university' => 'الجامعة',
        'SCC' => 'التخصص',
        'city' => 'المدينة',
